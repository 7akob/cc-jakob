...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names = {"Jakob", "Morris", "Sauli", "Sanna", "Petteri"};
    double[] testdata = {27, 22, 70, 32, 40};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //vi fyller vår arraylist med värderna från testdata-arrayen
        for (int i = 0; i < testdata.length; i++) {

            //Vi lägger till datobjekt til dataItems
    ...
    public void calculate(View view){
        ...
        outputCalc.setText(String.format(
